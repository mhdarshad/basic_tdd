...
//     if((state.location != '/config') && (sl<Configration>().dbData ==null)){
//       print("no data");
//       return '/config';
//     }
//     if ((state.location != '/config') && (state.location != '/login') &&  (sl<Configration>().tocken ==null) ) {
//       print("no data");
//       return '/login';
//     }
...
//       case Routename.editvenodreproduct:
//       // TODO: Handle this case.
//         return  CUri("editvenodreproduct");
