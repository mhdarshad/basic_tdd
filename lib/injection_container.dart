...
import 'tdd/domain/usecase/class_mat_booking/class_mat_booking.dart';
...
import 'tdd/presentaion/modules/mat_details_for_scedule/mat_detailes_scedule_controller.dart';
...
_bloc(){
  ...
  sl.registerFactory(() => MatDetailesSceduleEvent(MatDetailesSceduleUseCase( repo: sl(),),));
