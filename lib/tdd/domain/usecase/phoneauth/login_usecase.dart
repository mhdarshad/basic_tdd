...
import '../../../presentaion/events/phoneauth/phone_login_mutation.dart';
import '../../../presentaion/events/phoneauth/phone_register_mutation.dart';
import '../../../presentaion/events/phoneauth/setuser_store.dart';
...
class PhoneLoginUseCase extends AuthUseCase<UsersData,PhoneRegisterModle>{
  ...
  Future<Either<Failure, bool>> logout() async{
    // print("phone: ${data.phone}");
    final  value = await repo.getRequest(Params(uri: Uri.parse("user/auth/logout"), methed: Methed.Post,));
