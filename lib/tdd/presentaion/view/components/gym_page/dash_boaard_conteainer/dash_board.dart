                        ...
                        const Row(
                          ...
                          child: Column(
                            children: [
                              ...
                              GestureDetector(
                                onTap: ()=> navigate.push(context, name:Routename.home,parms:{'page':BottemNavigationsData.scedule.name}),
                                child: Container(
                                  height: 32,
                                  decoration: BoxDecoration(
                          ...
                          child: Column(
                            children: [
                              ...
                              GestureDetector(
                                onTap: ()=> navigate.push(context, name:Routename.home,parms:{'page':BottemNavigationsData.plans.name}),
                                child: Container(
                                  height: 32,
                                  decoration: BoxDecoration(
                                    color: FlutterFlowTheme.of(context).primaryText,
      ...
      children: [
        ...
        ListView(
          ...
          children: list.map((e) => GestureDetector(
            onTap: (){
              navigate.push(context, name: Routename.sceduleDetais,qparms: {
                'class_id':e.id.toString()
              });
            },
            child: Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(16, 12, 16, 0),
